...
// Funksjon for menyen til valg av rom
int room()
{
  //Meny oppsett
  returnVal = 0;
...
// Funksjon for menyen til valg av hvor lenge man skal booke et rom
int len()
{
  returnVal = 1;
  tft.fillScreen(ST77XX_BLACK);
...
// Funksjon for menyen for valg av antall gjester
int guestBooking()
{
  returnVal = 0;
  tft.fillScreen(ST77XX_BLACK);
...
// Funksjon menyen for når man skal booke et rom
int when()
{
  returnVal = 1;
  tft.fillScreen(ST77XX_BLACK);
